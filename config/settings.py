...
MIDDLEWARE = [
    ...
    'leads.middleware.SubscriptionMiddleware',
...
HUBSPOT_SCOPES = 'crm.objects.contacts.read%20crm.objects.contacts.write%20oauth'  # URL-encoded spaces between scopes
